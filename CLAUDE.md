...
- **Entry point**: `core/publish.sh` — invoked by `action.yml` composite step
...
| `core/publish.sh` | Lambda image update script |
| `tests/action.bats` | BATS integration tests |
| `tests/__mocks__/aws` | AWS CLI stub (records invocations) |
